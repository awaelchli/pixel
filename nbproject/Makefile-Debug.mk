...
${OBJECTDIR}/core/film.o: core/film.cc
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -O2 -Icore -Ifilm -Itonemapper -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/film.o core/film.cc
...
${OBJECTDIR}/core/tonemapper.o: core/tonemapper.cc
	${MKDIR} -p ${OBJECTDIR}/core
	${RM} "$@.d"
	$(COMPILE.cc) -g -O2 -Icore -Ifilm -Itonemapper -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/tonemapper.o core/tonemapper.cc

${OBJECTDIR}/film/box_film.o: film/box_film.cc
	${MKDIR} -p ${OBJECTDIR}/film
	${RM} "$@.d"
	$(COMPILE.cc) -g -O2 -Icore -Ifilm -Itonemapper -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/film/box_film.o film/box_film.cc
...
${OBJECTDIR}/tonemapper/clamp_tonemapper.o: tonemapper/clamp_tonemapper.cc
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -O2 -Icore -Ifilm -Itonemapper -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tonemapper/clamp_tonemapper.o tonemapper/clamp_tonemapper.cc
...
${OBJECTDIR}/core/film_nomain.o: ${OBJECTDIR}/core/film.o core/film.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -O2 -Icore -Ifilm -Itonemapper -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/film_nomain.o core/film.cc;\
	else  \
...
${OBJECTDIR}/core/tonemapper_nomain.o: ${OBJECTDIR}/core/tonemapper.o core/tonemapper.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -O2 -Icore -Ifilm -Itonemapper -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/tonemapper_nomain.o core/tonemapper.cc;\
	else  \
...
${OBJECTDIR}/film/box_film_nomain.o: ${OBJECTDIR}/film/box_film.o film/box_film.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -O2 -Icore -Ifilm -Itonemapper -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/film/box_film_nomain.o film/box_film.cc;\
	else  \
...
${OBJECTDIR}/tonemapper/clamp_tonemapper_nomain.o: ${OBJECTDIR}/tonemapper/clamp_tonemapper.o tonemapper/clamp_tonemapper.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -O2 -Icore -Ifilm -Itonemapper -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tonemapper/clamp_tonemapper_nomain.o tonemapper/clamp_tonemapper.cc;\
	else  \
